...
git clone https://github.com/devilrap978.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf devilrap978 && rm -rf .telegram-cli && git clone https://github.com/devilrap978.git && cd devilrap978 && ./launch.sh install && ./launch.sh
~~~~~
